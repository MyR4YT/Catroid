...
public class BackpackScriptSerializerAndDeserializer implements JsonSerializer<Script>, JsonDeserializer<Script> {
	...
	private static final String PACKAGE_NAME = "com.myradev.lunarcode.content.";
	private static final String PACKAGE_NAME_PHYSICS = "com.myradev.lunarcode.physics.content.bricks.";
