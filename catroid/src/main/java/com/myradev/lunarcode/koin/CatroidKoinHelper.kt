...
package com.myradev.lunarcode.koin
...
import com.myradev.lunarcode.db.AppDatabase
import com.myradev.lunarcode.db.DatabaseMigrations
import com.myradev.lunarcode.retrofit.CatroidWebServer
import com.myradev.lunarcode.stage.HmsSpeechRecognitionHolder
import com.myradev.lunarcode.stage.SpeechRecognitionHolder
import com.myradev.lunarcode.stage.SpeechRecognitionHolderFactory
import com.myradev.lunarcode.sync.DefaultFeaturedProjectSync
import com.myradev.lunarcode.sync.DefaultProjectsCategoriesSync
import com.myradev.lunarcode.sync.FeaturedProjectsSync
import com.myradev.lunarcode.sync.ProjectsCategoriesSync
import com.myradev.lunarcode.ui.controller.BackpackListManager
import com.myradev.lunarcode.ui.recyclerview.adapter.CategoriesAdapter
import com.myradev.lunarcode.ui.recyclerview.adapter.FeaturedProjectsAdapter
import com.myradev.lunarcode.ui.recyclerview.repository.LocalHashVersionRepository
import com.myradev.lunarcode.ui.recyclerview.repository.DefaultLocalHashVersionRepository
import com.myradev.lunarcode.ui.recyclerview.repository.DefaultFeaturedProjectsRepository
import com.myradev.lunarcode.ui.recyclerview.repository.DefaultProjectCategoriesRepository
import com.myradev.lunarcode.ui.recyclerview.repository.FeaturedProjectsRepository
import com.myradev.lunarcode.ui.recyclerview.repository.ProjectCategoriesRepository
import com.myradev.lunarcode.ui.recyclerview.viewmodel.MainFragmentViewModel
import com.myradev.lunarcode.utils.MobileServiceAvailability
import com.myradev.lunarcode.utils.NetworkConnectionMonitor
