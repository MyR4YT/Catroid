 ...
 */
package com.myradev.lunarcode.formulaeditor;
...
import com.myradev.lunarcode.formulaeditor.function.ArduinoFunctionProvider;
import com.myradev.lunarcode.formulaeditor.function.BinaryFunction;
import com.myradev.lunarcode.formulaeditor.function.FormulaFunction;
import com.myradev.lunarcode.formulaeditor.function.FunctionProvider;
import com.myradev.lunarcode.formulaeditor.function.MathFunctionProvider;
import com.myradev.lunarcode.formulaeditor.function.ObjectDetectorFunctionProvider;
import com.myradev.lunarcode.formulaeditor.function.RaspiFunctionProvider;
import com.myradev.lunarcode.formulaeditor.function.TernaryFunction;
import com.myradev.lunarcode.formulaeditor.function.TextBlockFunctionProvider;
import com.myradev.lunarcode.formulaeditor.function.TouchFunctionProvider;
import com.myradev.lunarcode.sensing.CollisionDetection;
import com.myradev.lunarcode.sensing.ColorAtXYDetection;
import com.myradev.lunarcode.sensing.ColorCollisionDetection;
import com.myradev.lunarcode.sensing.ColorEqualsColor;
...
import static com.myradev.lunarcode.formulaeditor.Functions.IF_THEN_ELSE;
import static com.myradev.lunarcode.formulaeditor.InternTokenType.BRACKET_CLOSE;
import static com.myradev.lunarcode.formulaeditor.InternTokenType.BRACKET_OPEN;
import static com.myradev.lunarcode.formulaeditor.InternTokenType.COLLISION_FORMULA;
import static com.myradev.lunarcode.formulaeditor.InternTokenType.FUNCTION_NAME;
import static com.myradev.lunarcode.formulaeditor.InternTokenType.FUNCTION_PARAMETERS_BRACKET_CLOSE;
import static com.myradev.lunarcode.formulaeditor.InternTokenType.FUNCTION_PARAMETERS_BRACKET_OPEN;
import static com.myradev.lunarcode.formulaeditor.InternTokenType.FUNCTION_PARAMETER_DELIMITER;
import static com.myradev.lunarcode.formulaeditor.InternTokenType.NUMBER;
import static com.myradev.lunarcode.formulaeditor.InternTokenType.OPERATOR;
import static com.myradev.lunarcode.formulaeditor.InternTokenType.SENSOR;
import static com.myradev.lunarcode.formulaeditor.InternTokenType.STRING;
import static com.myradev.lunarcode.formulaeditor.InternTokenType.USER_DEFINED_BRICK_INPUT;
import static com.myradev.lunarcode.formulaeditor.InternTokenType.USER_LIST;
import static com.myradev.lunarcode.formulaeditor.InternTokenType.USER_VARIABLE;
import static com.myradev.lunarcode.formulaeditor.common.Conversions.FALSE;
import static com.myradev.lunarcode.formulaeditor.common.Conversions.TRUE;
import static com.myradev.lunarcode.formulaeditor.common.Conversions.booleanToDouble;
import static com.myradev.lunarcode.formulaeditor.common.Conversions.convertArgumentToDouble;
import static com.myradev.lunarcode.formulaeditor.common.FormulaElementOperations.interpretOperatorEqual;
import static com.myradev.lunarcode.formulaeditor.common.FormulaElementOperations.interpretSensor;
import static com.myradev.lunarcode.formulaeditor.common.FormulaElementOperations.interpretUserDefinedBrickInput;
import static com.myradev.lunarcode.formulaeditor.common.FormulaElementOperations.interpretUserList;
import static com.myradev.lunarcode.formulaeditor.common.FormulaElementOperations.interpretUserVariable;
import static com.myradev.lunarcode.formulaeditor.common.FormulaElementOperations.isInteger;
import static com.myradev.lunarcode.formulaeditor.common.FormulaElementOperations.normalizeDegeneratedDoubleValues;
import static com.myradev.lunarcode.formulaeditor.common.FormulaElementOperations.tryInterpretCollision;
import static com.myradev.lunarcode.formulaeditor.common.FormulaElementOperations.tryInterpretDoubleValue;
import static com.myradev.lunarcode.formulaeditor.common.FormulaElementOperations.tryInterpretElementRecursive;
import static com.myradev.lunarcode.formulaeditor.common.FormulaElementOperations.tryParseIntFromObject;
import static com.myradev.lunarcode.formulaeditor.common.FormulaElementResources.addFunctionResources;
import static com.myradev.lunarcode.formulaeditor.common.FormulaElementResources.addSensorsResources;
