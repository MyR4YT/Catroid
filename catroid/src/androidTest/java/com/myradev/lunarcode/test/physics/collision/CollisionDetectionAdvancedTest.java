...
public class CollisionDetectionAdvancedTest {
	...
	public void setUp() throws Exception {
		...
		initializeSprite(sprite1, com.myradev.lunarcode.test.R.raw.collision_donut, "collision_donut.png");
		initializeSprite(sprite2, com.myradev.lunarcode.test.R.raw.icon, "icon.png");
