...
public class CollisionDetectionPolygonCreationTest {
	...
	public void testRectangle() throws IOException {
		CollisionInformation collisionInformation = generateCollisionInformation(com.myradev.lunarcode.test.R.raw
	...
	public void testSimpleConvexPolygon() throws IOException {
		CollisionInformation collisionInformation = generateCollisionInformation(com.myradev.lunarcode.test.R.raw.complex_single_convex_polygon, "complex_single_convex_polygon.png");
		collisionInformation.printDebugCollisionPolygons();
	...
	public void testDonutPolygons() throws IOException {
		CollisionInformation collisionInformation = generateCollisionInformation(com.myradev.lunarcode.test.R.raw.collision_donut,
				"collision_donut.png");
		collisionInformation.printDebugCollisionPolygons();
